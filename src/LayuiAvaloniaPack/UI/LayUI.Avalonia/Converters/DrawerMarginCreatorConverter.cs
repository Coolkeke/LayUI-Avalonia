...
{
    public class DrawerMarginCreatorConverter : IMultiValueConverter
    {
        private static DrawerMarginCreatorConverter _Instance; 
        public static DrawerMarginCreatorConverter Instance => _Instance ?? (_Instance = new DrawerMarginCreatorConverter());
